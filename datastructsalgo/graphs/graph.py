...
class Graph(object):
    ...
    >>> from datastructsalgo.graphs import Graph
    >>> from datastructsalgo.utils import AdjacencyListGraphNode
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if implementation is 'adjacency_list':
            from datastructsalgo.graphs.adjacency_list import AdjacencyList
