from datastructsalgo.utils.misc_util import _check_type, NoneType
...
class Array(object):
    '''
    Abstract class for arrays in datastructsalgo.
    '''
...
class OneDimensionalArray(Array):
    ...
    >>> from datastructsalgo import OneDimensionalArray
...
class DynamicOneDimensionalArray(DynamicArray, OneDimensionalArray):
    ...
    >>> from datastructsalgo import DynamicOneDimensionalArray as DODA
    >>> arr = DODA(int, 0)
    >>> arr.append(1)
    >>> arr.append(2)
    >>> arr[0]
...
class ArrayForTrees(DynamicOneDimensionalArray):
    ...
    datastructsalgo.linear_data_structures.arrays.DynamicOneDimensionalArray
    """
    def _modify(self):
        if self._num/self._size < self._load_factor:
            new_indices = {}
